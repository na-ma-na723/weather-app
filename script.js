let weather = {
    ...
    //         else if( desc == "Smoke" ) document.querySelector("#main").style.backgroundImage = "url(./assests/smoke_night.jpg)";
    ...
    //         else if( desc == "Smoke" ) document.querySelector("#main").style.backgroundImage = "url(./assests/smoke_day.jpg)";
    ...
    getBackground: function(desc, t) {
        if( t < 6 || t > 17 ) {
            if( desc == "Rain" ) document.body.style.backgroundImage = "url(./assests/rainy_night.gif)";
            else if( desc == "Clouds") document.body.style.backgroundImage = "url(./assests/cloudy_sky_night.gif)";
            else if( desc == "Clear" ) document.body.style.backgroundImage = "url(./assests/clear_sky_night.gif)";
            else if( desc == "Snow" ) document.body.style.backgroundImage = "url(./assests/snow_night.gif)";
            else if( desc == "Fog" ) document.body.style.backgroundImage = "url(./assests/fog_night.gif)";
            else if( desc == "Mist" ) document.body.style.backgroundImage = "url(./assests/mist_night.gif)";
            else if( desc == "Smoke" ) document.body.style.backgroundImage = "url(./assests/smoke_night.jpg)";
            ...
            if( desc == "Rain" ) document.body.style.backgroundImage = "url(./assests/rainy_day.gif)";
            else if( desc == "Clouds") document.body.style.backgroundImage = "url(./assests/cloudy_sky_day.gif)";
            else if( desc == "Clear" ) document.body.style.backgroundImage = "url(./assests/clear_sky_day.gif)";
            else if( desc == "Snow" ) document.body.style.backgroundImage = "url(./assests/snow_day.gif)";
            else if( desc == "Fog" ) document.body.style.backgroundImage = "url(./assests/fog_day.gif)";
            else if( desc == "Mist" ) document.body.style.backgroundImage = "url(./assests/mist_day.gif)";
            else if( desc == "Smoke" ) document.body.style.backgroundImage = "url(./assests/smoke_day.jpg)";
